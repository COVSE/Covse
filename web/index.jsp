...
<%-- 
    Document   : index
    Created on : 4/03/2014, 08:56:53 AM
    Author     : USUARIO
--%>
...
<li><a href="Iniciosesion.jsp" class="parent"><span>Inicio sesión</span></a></li>
...
<br /><br /><br /><br /><br /><br /><br /><br />
	...
	<div class="ws_images"><ul>
		<li><img src="data0/images/8.jpg" alt="" title="" id="wows0_0"/></li>
		<li><img src="data0/images/9.jpg" alt="" title="" id="wows0_1"/></li>
		<li><a href="http://wowslider.com/vf"><img src="data0/images/10.jpg" alt="full screen slider" title="" id="wows0_2"/></a></li>
		<li><img src="data0/images/11.jpg" alt="" title="" id="wows0_3"/></li>
	</ul></div>
	<div class="ws_bullets"><div>
		<a href="#" title=""><img src="data0/tooltips/8.jpg" alt=""/>2</a>
		<a href="#" title=""><img src="data0/tooltips/9.jpg" alt=""/>3</a>
		<a href="#" title=""><img src="data0/tooltips/10.jpg" alt=""/>4</a>
		<a href="#" title=""><img src="data0/tooltips/11.jpg" alt=""/>5</a>
	</div></div><span class="wsl"><a href="http://wowslider.com/vu">image carousel</a> by WOWSlider.com v7.1</span>
